...
public class BlogController {
	...
	public ResponseEntity<ResponseStructure<BlogResponse>> blogService(@RequestBody BlogRequest blogRequest, int blogId)
	{
		return blogService.blogService(blogRequest,blogId);
	}
}
